...
loop do #ptite boucle qui part de là
	...
	client.update("@charles_dacquay Salut Chef, juste pour te dire qu'il est " + time.hour.to_s + "h" + time.min.to_s) #petit message bien relou qui envoi l'heure au patron
	minuteur += 1 #ajoute 1 au compteur dans le minuteur
	puts "heure envoyé, charles_dacquay doit être bien énervé!" #affiche dans la console ce qui se passe
